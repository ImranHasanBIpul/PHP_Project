					...
					<div class="panel panel-flat">
						...
						<table class="table table-bordered datatable-basic">
						  ...
						  <?php 
								...
								$bannarList= mysqli_query($dbCon, $selectQry);
					
								foreach($bannarList as $key => $bannar){
								?>
								<tr>
									<td><?php echo ++$key;?></td>
									<td><?php echo $bannar["title"];?></td>
									<td><?php echo $bannar["sub_title"];?></td>
									<td><?php echo $bannar["details"];?></td>
									<td>
										<img class="img-responsive" width="80" height="80" src="<?php echo '../uploads/bannerimg/'.$bannar["image"];?>" alt="">
									</td>
									<td class="text-center">
											<a href="bannarUpdate.php?banner_id=<?php echo $bannar['id']; ?>"><i class="icon-pencil7"></i></a>
											<a href="bannarDelete.php?banner_id=<?php echo $bannar['id']; ?>"><i class="icon-trash"></i></a>
										</td>
								</tr>
								<?php }?>
