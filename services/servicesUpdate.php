...
<hr>
						...
						<form class="form-horizontal" action="../controller/bannerController.php" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2" for="icon_name">Icon Iame</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" id="icon_name" name="icon_name" >
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2" for="service_details">Services Details</label>
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control" id="service_details" placeholder="Default textarea" id="detials" name="service_details" required>  </textarea>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="text-right">
									...
									<button type="submit" class="btn btn-primary" name="update_service">Submit <i class="icon-arrow-right14 position-right"></i></button>
								</div>
							</form>
						</div>
					</div>
