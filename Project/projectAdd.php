			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="bannar.php"> <i class="icon-home2 position-left"></i>Project</a></li>
						...
						<form class="form-horizontal" action="../controller/projectController.php" method="post" enctype="multipart/form-data">
								...
								?>
									<div class="alert alert-success no-border">
										...
										$categoryList= mysqli_query($dbCon, $dropDownQry);
										?>
								...
								<div class="text-right">
									<a href="project.php" class="btn btn-primary">Back To List</a>

									<button type="submit" class="btn btn-primary" name="save_project">Submit <i class="icon-arrow-right14 position-right"></i></button>
								</div>
							</form>
